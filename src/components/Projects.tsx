...
const PROJECTS: ProjectData[] = [
  {
    ...
    tagline: 'Multilingual peer-to-peer skill exchange platform supporting English, Hindi, Tamil, Telugu, and Kannada. Focused on accessibility and reducing language barriers in learning communities.',
    stack: ['React', 'Python', 'MySQL', 'Full Stack'],
  ...
  },
  {
    ...
    tagline: 'AI-powered tutor platform that converts PDF study materials into video lectures using automated workflows. Built interactive learning experiences for a team of 4.',
    stack: ['React', 'Python', 'AI', 'EdTech'],
  ...
  },
  {
    id: 'gramify',
    name: 'Gramify',
    category: 'Rural E-Commerce',
    tagline: 'Rural commerce platform promoting local products under the "One Village One Product" initiative. Led UI/UX development optimized for users with low digital literacy.',
    stack: ['Flutter', 'UI/UX', 'Dart'],
  ...
  },
  {
    ...
    tagline: 'Nutrition internship platform with dietary planning, case-study modules, and progress tracking. Managed complete product lifecycle from requirement gathering to deployment.',
  ...
  },
  {
    ...
    tagline: 'Co-founded a digital agency delivering web development, UI/UX, branding, and digital solutions. Completed 5+ projects for startups and local businesses, generating Rs.20K+ revenue.',
    stack: ['React', 'Python', 'Flutter', 'Branding'],
