...
const EMAIL = 'nidigantiak@gmail.com';

function useEmailTypewriter(active: boolean) {
  ...
  useEffect(() => {
    if (phase === 'typing') {
      ...
      const t = setTimeout(() => setText(EMAIL.slice(0, text.length + 1)), 55);
      return () => clearTimeout(t);
    }
    if (phase === 'pause') {
    ...
    if (phase === 'erasing') {
      ...
      const t = setTimeout(() => setText(prev => prev.slice(0, -1)), 28);
      return () => clearTimeout(t);
    }
  }, [phase, text]);
...
const SOCIALS = [
  {
    label: 'GitHub',
    href: 'https://github.com/aaruhyakumar2006',
    svg: (
...
export function Contact() {
  ...
  const emailText = useEmailTypewriter(sectionInView);
        ...
        <div className="max-w-360 mx-auto px-[clamp(1.25rem,5vw,5rem)] pt-[clamp(5rem,10vw,11rem)] pb-0">
          ...
          <div className="mb-[clamp(3rem,6vw,8rem)]">
            ...
            <div className="overflow-hidden mb-8">
              <a
                ref={emailRef}
                href="mailto:nidigantiak@gmail.com"
          ...
          >
            {[
              ...
              { label: 'Status', value: 'Open to opportunities', pulse: true },
            ].map((item, i) => (
              <div
                key={item.label}
