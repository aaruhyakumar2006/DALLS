...
// ─── Floating vocabulary ───────────────────────────────────────────────────────
const WORDS = [
  'React',       'Python',       'Flutter',       'MySQL',
  'Git',         'GitHub',       'VS Code',       'Android Studio',
  'HTML/CSS',    'JavaScript',   'Java',          'C',
  'Machine Learning', 'REST APIs', 'UI/UX',       'Figma',
  'Scalable',    'Accessible',   'Performant',    'Real-time',
  'EdTech',      'Multilingual', 'Open Source',   'Startup',
];

const LINE1 = 'Built to Ship.';
