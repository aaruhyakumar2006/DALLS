...
const FLOAT_WORDS = [
  ...
  'Wipro', '2024', 'Aprotech', 'Generative AI',
  'Engineering', 'Development', 'Backend', 'Frontend',
  'Machine Learning', 'Python', 'Accredited', 'India',
  'Awarded', 'Completed', '2+ Years', 'Production',
];
        ...
        >
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-10 lg:gap-16">
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                Full Stack Developer &mdash; Co-Founder, Nascraft Digitals
              </motion.p>

              {/* Stack tags */}
              <div className="flex flex-wrap gap-2 mt-1">
                {['React', 'Python', 'Flutter', 'MySQL', 'Git', 'Android Studio'].map((tag, i) => (
                  <motion.span
                    key={tag}
