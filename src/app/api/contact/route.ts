...
function getResend() {
  if (!resend) resend = new Resend(process.env.RESEND_API_KEY ?? 'missing');
  return resend;
}
...
<head>
  ...
  <title>New Message — Aaruhya Kumar N | DALLS</title>
  <style>
          ...
          <tr>
            <td style="padding-top: 20px;">
              <p style="font-size:10px; letter-spacing:0.12em; color:rgba(255,255,255,0.12); line-height:1.8;">
                This message was submitted via the contact form at dalls.vercel.app<br/>
                © 2026 Aaruhya Kumar N · All rights reserved
              </p>
            </td>
          </tr>
